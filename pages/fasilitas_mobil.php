...
<body>
  ...
  <div class="container">
	  <div class="row"><br>
        ...
        <!-- Select Multiple -->
        <div class="form-group">
          <label class="col-md-4 control-label" for="Area of Interest">Mobil</label>
          <div class="col-md-5">
            <select id="Area of Interest" name="Area of Interest" class="form-control">
              <option value="1">Elf</option>
              <option value="2">Gran Max</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group">
		  ...
		  <div class="col-md-1">
			<label class="col-md-offset-2 control-label">Jemput</label>
		  </div>
		  <div class="col-md-2">
        ...
        <div class="form-group">
          ...
          <div class="col-md-5">
            <input id="Message" name="Message" type="text" placeholder="Acara mulai jam 16.00 dan selesai jam 18.00" class="form-control input-md">
